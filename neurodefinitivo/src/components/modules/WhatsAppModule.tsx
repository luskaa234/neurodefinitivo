  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card>
          <CardContent className="p-4">
            <MessageCircle className="mb-2 text-purple-600" />
        ...
        <DialogContent className="max-w-5xl">
          ...
          <Tabs value={tab} onValueChange={(v) => setTab(v as any)}>
            ...
            <TabsContent value="with" className="grid grid-cols-2 gap-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  <Button className="bg-green-600" onClick={sendWithAppointment}>
            ...
            <TabsContent value="free">
              ...
              <Button className="mt-3 bg-green-600" onClick={sendFree}>
